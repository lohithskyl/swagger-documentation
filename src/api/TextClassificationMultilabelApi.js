...
/**
* TextClassificationMultilabel service.
* @module api/TextClassificationMultilabelApi
* @version 1.0.0
*/
export default class TextClassificationMultilabelApi {

    /**
    * Constructs a new TextClassificationMultilabelApi. 
    * @alias module:api/TextClassificationMultilabelApi
    * @class
    ...
    */
     ...
     * @callback module:api/TextClassificationMultilabelApi~apiOrganisationsOrgIdProjectsProjectIdDataSetsDatasetIdCollectPostCallback
     ...
     * Collects data based upon template and uploads to dataset
     * @param {module:api/TextClassificationMultilabelApi~apiOrganisationsOrgIdProjectsProjectIdDataSetsDatasetIdCollectPostCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:api/TextClassificationMultilabelApi~apiOrganisationsOrgIdProjectsProjectIdMlModelsMlModelIdInferenceBatchPostCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/TextClassificationMultilabelApi~apiOrganisationsOrgIdProjectsProjectIdMlModelsMlModelIdInferenceBatchPostCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:api/TextClassificationMultilabelApi~apiOrganisationsOrgIdProjectsProjectIdMlModelsMlModelIdInferencePostCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * Inferences data based upon template.
     * @param {module:api/TextClassificationMultilabelApi~apiOrganisationsOrgIdProjectsProjectIdMlModelsMlModelIdInferencePostCallback} callback The callback function, accepting three arguments: error, data, response
     */
