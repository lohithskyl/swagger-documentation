...
/**
* TextClassificationMulticlass service.
* @module api/TextClassificationMulticlassApi
* @version 1.0.0
*/
export default class TextClassificationMulticlassApi {

    /**
    * Constructs a new TextClassificationMulticlassApi. 
    * @alias module:api/TextClassificationMulticlassApi
    * @class
    ...
    */
     ...
     * @callback module:api/TextClassificationMulticlassApi~apiOrganisationsOrgIdProjectsProjectIdDataSetsDatasetIdCollectPostCallback
     ...
     * Collects data based upon template and uploads to dataset
     * @param {module:api/TextClassificationMulticlassApi~apiOrganisationsOrgIdProjectsProjectIdDataSetsDatasetIdCollectPostCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:api/TextClassificationMulticlassApi~apiOrganisationsOrgIdProjectsProjectIdMlModelsMlModelIdInferenceBatchPostCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/TextClassificationMulticlassApi~apiOrganisationsOrgIdProjectsProjectIdMlModelsMlModelIdInferenceBatchPostCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:api/TextClassificationMulticlassApi~apiOrganisationsOrgIdProjectsProjectIdMlModelsMlModelIdInferencePostCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * Inferences data based upon template.
     * @param {module:api/TextClassificationMulticlassApi~apiOrganisationsOrgIdProjectsProjectIdMlModelsMlModelIdInferencePostCallback} callback The callback function, accepting three arguments: error, data, response
     */
